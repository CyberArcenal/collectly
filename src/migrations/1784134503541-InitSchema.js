 ...
 */
module.exports = class InitSchema1784134503541 {
    name = 'InitSchema1784134503541'

    /**
     * @param {QueryRunner} queryRunner
     */
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "temporary_penalty_transactions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" decimal(12,2) NOT NULL, "penaltyDate" datetime NOT NULL, "reason" varchar, "deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "debtId" integer, "status" varchar CHECK( "status" IN ('pending','collected','waived','reversed') ) NOT NULL DEFAULT ('pending'), CONSTRAINT "FK_fbdfada962daff40335acff047a" FOREIGN KEY ("debtId") REFERENCES "debts" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "penalty_transactions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" decimal(12,2) NOT NULL, "penaltyDate" datetime NOT NULL, "reason" varchar, "deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "debtId" integer, CONSTRAINT "FK_fbdfada962daff40335acff047a" FOREIGN KEY ("debtId") REFERENCES "debts" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
