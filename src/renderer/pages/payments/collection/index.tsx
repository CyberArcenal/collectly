...
const CollectionPage: React.FC = () => {
  ...
  const [selectedDebtor, setSelectedDebtor] = useState<DebtorCollection | null>(null);
  ...
  return (
    <div className="m-1" style={{ backgroundColor: 'var(--background-color)' }}>
      ...
      >
        ...
        {/* Period Navigation */}
        <div className="mb-4">
          <PeriodTabs value={periodType} onChange={setPeriodType} disabled={loading} />
        </div>
          ...
          <div className="flex-1 flex items-center justify-center min-h-[200px]">
            {loading && (
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-sm text-[var(--text-secondary)]">Loading collection schedule...</p>
              </div>
            )}
            {error && (
        ...
        {!loading && !error && data && (
          <>
            ...
            {data.debtors.length > 0 ? (
              <CollectionTable debtors={paginatedDebtors} onMarkPaid={handleMarkPaid} />
            ) : (
              <div
