...
module.exports = async (params, queryRunner) => {
  ...
  if (mode === "online") {
    ...
    const response = await onlineClient.delete(`/api/v1/payments/${id}/permanent/`);
    ...
    return {
      status: true,
      message: "Payment permanently deleted on server",
      data: null,
    };
  } else {
    ...
    return {
      status: true,
      message: "Payment permanently deleted locally",
      data: null,
    };
  }
};